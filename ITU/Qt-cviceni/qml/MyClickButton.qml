...
Rectangle {
    ...
    property color pressedColor: "#90EE90";
    ...
    color: mouse.pressed ? pressedColor : btnColor
    ...
    Text {
        ...
        anchors.centerIn: parent // Zarovnání na střed tlačítka
        font.pointSize: 16 // Vhodné formátování textu
